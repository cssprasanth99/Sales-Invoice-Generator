...
const Header = () => {
  ...
  const user = { name: "Alex", email: "alex@gmail.com" };
  const logout = () => {};
  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 bg-gray-100 ${
        isScroll ? "bg-white/95 backdrop-blur-sm shadow-lg" : "bg-white/0"
      }`}
    >
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className="bg-gradient-to-r from-blue-950 to-blue-900 hover:from-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg"
                >
                  Sign Up
                </Link>
              </>
        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg">
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <Link
                href="/signup"
                className="w-full block px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200"
              >
                Sign Up
              </Link>
            </>
