    ...
    <div className="relative">
      ...
      >
        {avatar ? (
          ...
          <div className="h-8 w-8 bg-gradient-to-br from-blue-950 to-blue-900 rounded-xl flex items-center justify-center">
        ...
        <div className="absolute right-0 mt-2 w-56 rounded-xl shadow-lg border border-gray-100 py-2 z-50">
          ...
          <div className="border-t border-gray-100 mt-2 pt-2">
            <a
              href=""
              onClick={onLogout}
              className="block px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors cursor-pointer"
            >
              Logout
            </a>
          </div>
